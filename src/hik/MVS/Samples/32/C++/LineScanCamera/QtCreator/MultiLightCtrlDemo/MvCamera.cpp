...
int CMvCamera::DisplayOneFrame(void* hwndDisplay,MV_CC_IMAGE* pDisplayInfo)
{
    return MV_CC_DisplayOneFrameEx2(m_hDevHandle, hwndDisplay, pDisplayInfo, 0);
}
...
//ch:HB图像解码 | en:HB Decode
int CMvCamera::HB_Decode(MV_CC_HB_DECODE_PARAM* pstDecodeParam)
{
    return MV_CC_HB_Decode(m_hDevHandle, pstDecodeParam);
}
