...
struct pci_device_id CxpDeviceId[] = {
    ...
    {CXP_VENDOR_ID, CXP6_DEVICE_ID, CXP_VENDOR_ID, CXP6_QUAD_SUBDEVICE_ID, 0, 0, 0},
    {CXP_VENDOR_ID, CXP6_DEVICE_ID, CXP_VENDOR_ID, CXP6_DUAL_SUBDEVICE_ID, 0, 0, 0},
    {CXP_VENDOR_ID, CXP6_DEVICE_ID, CXP_VENDOR_ID, CXP6_OCTA_SUBDEVICE_ID, 0, 0, 0},
    {CXP_VENDOR_ID, CXP12_DEVICE_ID, CXP_VENDOR_ID, CXP12_DUAL_SUBDEVICE_ID, 0, 0, 0},
    {0,}
};
...
#else
	pstPciDevice->pstClass = class_create((const char *)chCxpClassName);
#endif
...
{
    printk(KERN_INFO "ModuleRemove enter!");
